var Form = new function () {
    ...
    this.init = function () {
        ...
        this.messages = {
            ...
            "firstname": "- поле обязательно для заполнения<br>- длина имени 2-26 символова<br>- поле должно содержать только буквы",
            "lastname": "- поле обязательно для заполнения<br>- длина имени 2-26 символова<br>- поле должно содержать только буквы",
    ...
    this.initElem = function () {
        ...
        this.transactionId = $('input[name="buid"]');
